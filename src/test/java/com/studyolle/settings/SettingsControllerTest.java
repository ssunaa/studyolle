...
class SettingsControllerTest {
    ...
    //@WithUserDetails(value = "김선화", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @WithAccount("김선화")
    ...
    void updateProfile() throws Exception {
        ...
        Account account = accountRepository.findByNickname("김선화");
    ...
    void updateProfile_fail() throws Exception {
        ...
        Account keesun = accountRepository.findByNickname("김선화");
